export const projects = [
  ...
  {
    id: 'codex-orchestrated-template',
    title: 'Codex Orchestrated Project Template',
    signal: 'agent.ops',
    featured: true,
    image: '/portfolio-assets/images/projects/codex-orchestrated-template/cover.png',
    problem: 'AI-assisted development needs a repeatable project skeleton for planning, delegating, reviewing, and shipping with multiple coding agents.',
    system: 'Template repository for orchestrated agentic software work, including structured project setup, workflow conventions, and handoff patterns for Codex-style coding agents.',
    aiRole: 'Coordinates planning, implementation, review, and iteration loops so AI agents can work from a consistent operating model instead of ad-hoc prompts.',
    impact: 'Reusable foundation for faster agentic project bootstrapping and more controlled multi-agent delivery.',
    stack: ['Codex', 'Agentic Workflow', 'Project Template', 'Automation', 'Developer Tools'],
    links: [{ label: 'GitHub', href: 'https://github.com/hdtinh57/codex-orchestrated-project-template', icon: 'fab fa-github' }],
    gallery: [{ src: '/portfolio-assets/images/projects/codex-orchestrated-template/cover.png', caption: 'Codex Development Template Cover' }],
  },
  {
    id: 'smartdocqa',
